    ...
    return (
      <div className='App'>
        <header className='App-header'>
          <h1 className='App-title'>Practica</h1>
        </header>

        {usuarios.map((usuario, key) => (
          <div className='usuario' key={key}>
            <div>
              <Usuario
                name={usuario.name}
                age={usuario.age}
              ...
              <Color eyeColor={usuario.eyeColor} />
              <FotoPerfil picture={usuario.picture} />
            </div>
            <Amigos friends={usuario.friends} />
